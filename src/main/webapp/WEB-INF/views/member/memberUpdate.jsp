...
<body>
    ...
    <br>
 	...
 	<br>	
        <div class="field">
            <b>아이디</b>
            <input type="text" name="id" id="id" value="${member.id}" disabled>
        <div id="idResult"></div>
        </div>        
                
        <div class="field">
            <b>비밀번호</b>
            <input class="userpw" type="password" name="pw" id="pw" value="${member.pw}">
        <div id="pwResult"></div>
        </div>        
        ...
        <div class="field address-form">
        	<b>주소</b>                 
       		<div>      			
                <input type="text" name="address" id="postcode" value="" placeholder="우편번호"
            	readonly >
         ...
         <div class="field">       
            ...
            readonly>
            	<input type="text" name="address" id="detailAddress" value="${member.address}">   
