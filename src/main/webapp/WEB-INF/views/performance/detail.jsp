		...
		<div class="d-flex flex py-5 my-5">
			...
			<div class="ms-5 flex-fill">
				<div class="border-4 border-bottom border-dark-subtle">
					<h3>${dto.performanceDTO.genrenm}
						<${dto.performanceDTO.prfnm}></h3>
				</div>
				<div class="mt-5">
					<table class="table table-borderless">
						...
						<tr>
							...
							<td class="ps-3">${dto.performanceDTO.prfpdfrom}~
								${dto.performanceDTO.prfpdto}</td>
						</tr>
						<tr>
               ...
               -->
				<div class="d-flex justify-content-end mt-3">
					...
					<!-- 아래버튼은 내가 임의로 추가 -->
					>
					<button type="submit" id="selectPerBtn"
						data-name="${dto.performanceDTO.prfnm}"
						...
						data-username="${member.name}" data-email="${member.email}"
						style="width: 200px; height: 70px; font-size: 21px; border-radius: 30px;">예매하기</button>
		...
		<div class="mb-3 border-bottom">
			<ul class="nav nav-underline">
				<li class="nav-item"><a class="nav-link active fs-5"
					id="review" data-target="review" aria-current="page" href="#">댓글</a>
				</li>
				<li class="nav-item"><a class="nav-link fs-5" id="map"
					data-target="map" href="#">오시는 길</a></li>
			</ul>
		</div>
