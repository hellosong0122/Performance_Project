...
public class KakaoLoginBO {
	...
	private final static String KAKAO_CLIENT_ID = "def57de2e617c3d2edcb20d588fc3f06";
	private final static String KAKAO_CLIENT_SECRET = "yD1sGD0xfsWh1NV25ivDBcUbPwJTvLnJ";
	private final static String KAKAO_REDIRECT_URI = "http://localhost:82/member/callbackKakao";
	...
	public String getAuthorizationUrl(HttpSession session) {
		...
		OAuth20Service oauthService = new ServiceBuilder()
				...
				.state(state).build(KakaoOAuthApi.instance()); // 앞서 생성한 난수값을 인증 URL생성시 사용함
